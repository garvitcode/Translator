...
class Player(tk.Frame):
	...
	def track_widgets(self):
		...
		self.songtrack['text'] = 'Sounds MP3 Player'
	...
	def prev_song(self, event=None):
		...
		if self.current > 0:
			...
			self.current = 0
		self.list.itemconfigure(self.current + 1, bg='grey')
		self.play_song()
...
if __name__ == '__main__':
	...
	img = PhotoImage(file='C:\\Users\\hp\\OneDrive\\Pictures\\icons\\music.gif')
	next_ = PhotoImage(file = 'C:\\Users\\hp\\OneDrive\\Pictures\\icons\\next.gif')
	prev = PhotoImage(file='C:\\Users\\hp\\OneDrive\\Pictures\\icons\\previous.gif')
	play = PhotoImage(file='C:\\Users\\hp\\OneDrive\\Pictures\\icons\\play.gif')
	pause = PhotoImage(file='C:\\Users\\hp\\OneDrive\\Pictures\\icons\\pause.gif')
