...
root = Tk()
root.iconbitmap(r"C:\\Users\\hp\\OneDrive\\Pictures\\img\\music-player.ico")
...
rewindPhoto = PhotoImage(file="C:\\Users\\hp\\OneDrive\\Pictures\\img\\rewind.png")
rewindBtn = Button(bottomFrame, image=rewindPhoto, borderwidth=0, command=rewind_music)
rewindBtn.grid(row=0, column=0, pady=30)

mutephoto = PhotoImage(file="C:\\Users\\hp\\OneDrive\\Pictures\\img\\mute.png")

volumePhoto = PhotoImage(file="C:\\Users\\hp\\OneDrive\\Pictures\\img\\volume.png")
...
statusbarPhoto = PhotoImage(file="C:\\Users\\hp\\OneDrive\\Pictures\\img\\statusbar_image.png")
